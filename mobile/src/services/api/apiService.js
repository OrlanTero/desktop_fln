...
const apiService = {
  ...
  users: {
    ...
    uploadPhoto: (id, formData) => {
      ...
      return apiClient
        .post(`/users/${id}/photo`, formData, config)
        .then(response => ({
          data: response.data,
        }))
        .catch(error => {
    ...
    updatePassword: (id, passwordData) =>
      apiClient
        .put(`/users/${id}/password`, passwordData)
        .then(response => ({
          data: response.data,
        }))
        .catch(error => {
  ...
  services: {
    ...
    addRequirement: (id, requirementData) =>
      apiClient.post(`/services/${id}/requirements`, requirementData),
    updateRequirement: (id, requirementData) =>
      apiClient.put(`/requirements/${id}`, requirementData),
  ...
  jobOrders: {
    ...
    getByService: (serviceId, proposalId) =>
      apiClient.get(`/job-orders/service/${serviceId}/proposal/${proposalId}`),
    ...
    getAssignedByProjectAndLiaison: (projectId, liaisonId) =>
      apiClient.get(`/job-orders/assigned/project/${projectId}/liaison/${liaisonId}`),
    getAssignedByProject: projectId => apiClient.get(`/job-orders/assigned/project/${projectId}`),
    getUnassignedByProject: projectId =>
      apiClient.get(`/job-orders/unassigned/project/${projectId}`),
    updateAssignedStatus: (id, statusData) =>
      apiClient.put(`/job-orders/assigned/${id}/status`, statusData),
    ...
    updateSubmissionStatus: (submissionId, status) =>
      apiClient.put(`/job-orders/submissions/${submissionId}/status`, { status }),
    deleteSubmission: submissionId => apiClient.delete(`/job-orders/submissions/${submissionId}`),
    deleteSubmissionAttachment: attachmentId =>
      apiClient.delete(`/job-orders/submissions/attachments/${attachmentId}`),
  },
  ...
  tasks: {
    ...
    getByLiaison: liaisonId =>
      apiClient.get(`/tasks/liaison/${liaisonId}`).then(response => {
    ...
    getById: id =>
      apiClient.get(`/tasks/${id}`).then(response => {
        return {
          data: {
            success: response.data.status === 'success',
            data: response.data.data || {},
    ...
    submitCompletion: formData => {
      ...
      return apiClient
        .post('/tasks/submit-completion', formData, config)
        .then(response => {
    ...
    updateSubmission: formData => {
      ...
      return apiClient
        .post('/tasks/update-submission', formData, config)
        .then(response => {
    ...
    getSubmissions: taskId =>
      apiClient.get(`/tasks/${taskId}/submissions`).then(response => {
        return {
          data: {
            success: response.data.status === 'success',
            data: response.data.data || [],
    ...
    getSubmissionById: submissionId =>
      apiClient.get(`/tasks/submissions/${submissionId}`).then(response => {
        return {
          data: {
            success: response.data.status === 'success',
            data: response.data.data || {},
    ...
    getLiaisonSubmissions: liaisonId =>
      apiClient.get(`/liaisons/${liaisonId}/task-submissions`).then(response => {
        return {
          data: {
            success: response.data.status === 'success',
            data: response.data.data || [],
    ...
    updateSubmissionStatus: (submissionId, status) =>
      apiClient.put(`/tasks/submissions/${submissionId}/status`, { status }).then(response => {
        return {
          data: {
            success: response.data.status === 'success',
            data: response.data.data || {},
    ...
    deleteSubmission: submissionId =>
      apiClient.delete(`/tasks/submissions/${submissionId}`).then(response => {
        return {
          data: {
            success: response.data.status === 'success',
            data: response.data.data || {},
    ...
    deleteSubmissionAttachment: attachmentId =>
      apiClient.delete(`/tasks/submissions/attachments/${attachmentId}`).then(response => {
        return {
          data: {
            success: response.data.status === 'success',
            data: response.data.data || {},
  ...
  messages: {
    ...
    sendMessageWithAttachments: formData => {
      ...
      return apiClient
        .post('/messages/with-attachments', formData, config)
        .then(response => {
    ...
    updateUserStatus: (userId, isOnline) =>
      apiClient
        .put(`/messages/status/${userId}`, { is_online: isOnline })
        .then(response => ({
          success: response.data.status === 'success',
        }))
        .catch(error => {
